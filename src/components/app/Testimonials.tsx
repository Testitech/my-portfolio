...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: "Working with Testimony was a game-changer for our company. His expertise in both design and development helped us launch our product in record time.",
    name: "Alex Johnson",
  ...
  {
    id: 2,
    quote: "The ability to understand both the technical and business aspects of our project made all the difference. Highly recommended for any complex project.",
    name: "Sarah Williams",
  ...
  {
    id: 3,
    quote: "Exceptional work on our DevOps infrastructure. We've seen dramatic improvements in our deployment speed and system reliability.",
    name: "Michael Chen",
...
export default function TestimonialsSection() {
  return (
    <section className="w-full py-20 bg-gradient-to-b from-primary/5 via-blue-50/30 to-transparent" id="testimonials">
